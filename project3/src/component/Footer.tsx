...
import { faArrowRight, faCalendar, faCheck, faCheckCircle, faComment, faEnvelope, faLocationDot, faPhone, faTimes } from '@fortawesome/free-solid-svg-icons';
...
const Footer = () =>  {
  ...
  return (
    <footer style={{ backgroundColor: "#002549", color: "white" ,fontFamily:"Philosopher"}}>
          ...
          <div className="col-3" style={{ textAlign: "left" }}>
            <ul style={{ listStyleType: "none", padding: 0 }}>
              ...
              <li style={{ marginBottom: "5px" }}>
                ...
                <FontAwesomeIcon icon={faLocationDot} /> 15 Đường số 2, Cư xá Lữ Gia,Phường 15, Quận 11, TP. HCM               </li>
              <li style={{ marginBottom: "5px" }}>
